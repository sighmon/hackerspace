module ApplicationHelper
	...
	def memberships_as_table(memberships)
		if memberships.try(:empty?)
			...
			table = "<table class='table table-bordered purchases_as_table'><thead><tr><th>Purchase date</th><th>Valid from</th><th>Duration</th><th>Autodebit?</th><th>Concession</th><th>Price paid</th></tr></thead><tbody>"
